...
public class GuiChat extends Deobfuscator {
    ...
    public boolean deobfuscate(byte[] classData) {
        ...
        for(FieldNode f : (List<FieldNode>) cn.fields) {
            ...
            if(f.signature != null) {
                if(isPrivate(f.access) && f.desc.contains("List") && f.signature.contains("String")) {
                    hasStringList = true;
                }
            }
        }
        ...
        return separateLogger && hasStringList && enablesKeyboardRepeatEvents && mouseDWheel;
    }
